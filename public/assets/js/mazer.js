            ...
            750: () => {
                ...
                function i(e, t, i, o) {
                    ...
                    window.requestAnimationFrame(function n(f) {
                        ...
                        var g = f - r;
                        o
                            ? ((e.style.height = u * g + "px"), (e.style.paddingTop = v * g + "px"), (e.style.paddingBottom = p * g + "px"), (e.style.marginTop = y * g + "px"), (e.style.marginBottom = h * g + "px"))
                            : ((e.style.height = a - u * g + "px"), (e.style.paddingTop = s - v * g + "px"), (e.style.paddingBottom = l - p * g + "px"), (e.style.marginTop = d - y * g + "px"), (e.style.marginBottom = c - h * g + "px")),
                            g >= t
                                ? ((e.style.height = ""),
                                    (e.style.paddingTop = ""),
